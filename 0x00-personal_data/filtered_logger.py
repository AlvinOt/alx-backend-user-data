#!/usr/bin/env python3
"""
Script to handle Personal Data
"""
...
def get_logger() -> logging.Logger:
    """
    Returns a Logger object to handle Personal Data
...
def get_db() -> mysql.connector.connection.MySQLConnection:
    """
    Returns a MySQLConnection object to access Personal Data database
...
def main():
    """
    Main function retrieving user data from db & log to console
    """
    db = get_db()
    cursor = db.cursor()
